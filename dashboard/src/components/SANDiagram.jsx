...
export default function SANDiagram({ data, focusedId, expandedIds = [], onNodeClick, selectedIds, onSelectToggle, searchQuery, onDeleteNode }) {
  ...
  const getSubNodes = (parentId) => activeNodes.filter(n => n.parentId === parentId && n.type !== "Port" && n.type?.toLowerCase() !== "port");
              ...
              {onDeleteNode && (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 6, border: '1px solid rgba(248,81,73,0.3)', background: 'rgba(248,81,73,0.1)', color: 'var(--accent-rose)',
                    transition: 'all 0.2s', cursor: 'pointer'
                  }}
                  title="Delete Device"
                >
                  <svg style={{ height: 14, width: 14 }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
